package com.sailing.rtsp;

import com.sailing.rtsp.IEvent;
...
public class RTSPClient extends Thread implements IEvent {
    ...
    private static final String VERSION ="RTSP/1.0rn";
    ...
    private void doTeardown() {
        ...
        sb.append(seq++);
        sb.append("rn");
        sb.append("User-Agent: RealMedia Player HelixDNAClient/10.0.0.11279 (win32)rn");
        sb.append("Session:");
        sb.append(sessionid);
        sb.append("rn");
    ...
    private void doSetup() {
        ...
        sb.append(seq++);
        sb.append("rn");
        sb.append("Transport: RTP/AVP;UNICAST;client_port=16264-16265;mode=playrn");
        sb.append("rn");
        System.out.println(sb.toString());
        send(sb.toString().getBytes());
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            RTSPClient client = new RTSPClient(
                    new InetSocketAddress("3.84.6.190", 554),
                    new InetSocketAddress("192.168.2.201", 0),
