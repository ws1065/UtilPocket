...
//    private ILogSystemAlarmDao logSystemAlarmDao;
    ...
    @Override
    public RespData<Boolean> startIpTablesPassageway(Passageway passageway, String protocol) {
        return null;
    }

    @Override
    public RespData<Boolean> stopIptablesPassageway(Passageway passageway, String protocol) {
        return null;
    }

    @Override
    public RespData<Boolean> operationFTP(FileSwapConfig fileSwapConfig) {
        return null;
    }

    @Override
    public RespData<Boolean> deleteFTP(String id) {
        return null;
    }

    @Override
    public RespData<List<String>> getFtpFolder(FileResourceConfig fileResourceConfig) {
        return null;
    }

    @Override
    public RespData<Boolean> testFTPConnect(FileResourceConfig fileResourceConfig) {
        return null;
    }

    @Override
    public RespData<Boolean> addOrDelFtpIptables(String ip, String type) {
        return null;
    }

    @Override
    public RespData<Boolean> execCmd(List<String> cmds) {
        return null;
    }

    @Override
    public RespData<String> logWarning() {
        return null;
    }
    ...
    @Override
    public RespData<Boolean> saveWhiteList(Integer count, WitList witList) {
        return null;
    }

    @Override
    public RespData<Boolean> deleteWhiteList(Integer count, WitList witList) {
        return null;
    }

    @Override
    public RespData<HomePage> homepage(Byte timeButton, Byte moduleType) {
        return null;
    }

    @Override
    public RespData<NetworkCardFlow> getNetcardFlowData(Byte timeButton) {
        return null;
    }
    ...
    @Override
    public RespData<Boolean> checkStatusOfNetworkCardOfThisPassageway(Passageway passageway) {
        return null;
    }
...
//        //log.info("dataArray is: " + Arrays.toString(dataArray));
    ...
    @Override
    public RespData<List<NetworkCard>> queryNetworkCards() {
        return null;
    }

    @Override
    public RespData<List<NetworkCard>> queryRuningNetWorkCards() {
        return null;
    }
    ...
    @Override
    public RespData<Boolean> updateSystem(String absolutePath) {
        return null;
    }
    ...
    @Override
    public RespData<Boolean> setVideoEnable(Boolean videoEnable) {
        return null;
    }

    @Override
    public RespData<Boolean> stopScheduleTaskOfInspectingPorts() {
        return null;
    }

    @Override
    public RespData<Boolean> restoreScheduleTaskOfInspectingPorts() {
        return null;
    }
